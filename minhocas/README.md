...
Sirva a pasta do repositório (o jogo usa módulos ES) e abra `/minhocas/`:

```bash
python3 -m http.server 8000   # depois: http://localhost:8000/minhocas/
```
...
```
minhocas/index.html          página e canvas
minhocas/css/style.css       casca e telas
js/engine/                   COMPARTILHADO com o Arqueiro: loop de passo fixo,
                             câmera, entrada, partículas, áudio, save,
                             gerador com semente, canvas em blocos
