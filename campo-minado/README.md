...
> Um dos jogos deste repositório — o outro é o [**Arqueiro**](../README.md),
> na raiz. Mesma receita: sem build, sem dependências.
...
Suba um servidor a partir da **raiz do repositório** e abra a pasta do jogo:

```bash
npm start                                  # na raiz do repositório
# depois abra http://localhost:8000/campo-minado/
```

Equivale a `python3 -m http.server 8000`. Qualquer servidor estático serve.
...
Rodando da raiz do repositório (os testes de todos os jogos correm juntos):
